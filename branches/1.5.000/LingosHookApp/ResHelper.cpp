...
const wxString ResHelper::MakeHomepageString()
{
	return wxString::Format( \
            ...
            wxT("<div style=\"text-align: center;\"><font style=\"font-size: 32pt;\">LingosHook</font>&nbsp;&nbsp;&nbsp;&nbsp;version&nbsp;") \
			wxT("%s") \
            wxT("</div><br/>") \
			wxT("<ul><font sytle=\"font-size:24pt;\">") \
            ...
            wxT("</font></ul>") \
            wxT("<br />") \
            wxT("<div style=\"text-align: right;\"><font style=\"font-size: 14pt;\"><a href=\"mailto:codejie@gmail.com\">codejie</a></span><br/>") \
			wxT("%s") \
            wxT("</div></body></html>") \
