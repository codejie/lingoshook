// -*- C++ -*- generated by wxGlade 0.6.3 on Wed Jan 19 17:47:26 2011
...
BEGIN_EVENT_TABLE(WordExportDialog, wxDialog)
    ...
    EVT_RADIOBUTTON(1000, WordExportDialog::OnRadioRangeAllClick)
    EVT_RADIOBUTTON(1001, WordExportDialog::OnRadioRangeAlphabetClick)
    EVT_RADIOBUTTON(1002, WordExportDialog::OnRadioRangePrefixClick)
    EVT_RADIOBUTTON(1003, WordExportDialog::OnRadioRangeSuffixClick)
    EVT_RADIOBUTTON(1010, WordExportDialog::OnRadioSeparatorCRLFClick)
    EVT_RADIOBUTTON(1011, WordExportDialog::OnRadioSeparatorCommaClick)
    EVT_RADIOBUTTON(1012, WordExportDialog::OnRadioSeparatorSemicolonClick)
    EVT_RADIOBUTTON(1013, WordExportDialog::OnRadioSeparatorCustomClick)
...
void WordExportDialog::OnRadioRangeAllClick(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnRadioRangeAllClick) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void WordExportDialog::OnRadioRangeAlphabetClick(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnRadioRangeAlphabetClick) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void WordExportDialog::OnRadioRangePrefixClick(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnRadioRangePrefixClick) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void WordExportDialog::OnRadioRangeSuffixClick(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnRadioRangeSuffixClick) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void WordExportDialog::OnRadioSeparatorCRLFClick(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnRadioSeparatorCRLFClick) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void WordExportDialog::OnRadioSeparatorCommaClick(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnRadioSeparatorCommaClick) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void WordExportDialog::OnRadioSeparatorSemicolonClick(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnRadioSeparatorSemicolonClick) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}


void WordExportDialog::OnRadioSeparatorCustomClick(wxCommandEvent &event)
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnRadioSeparatorCustomClick) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}
...
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnCheckOptionWord) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}
...
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnBtnBrowse) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}
...
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnBtnExport) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}
...
{
    event.Skip();
    wxLogDebug(wxT("Event handler (WordExportDialog::OnBtnClose) not implemented yet")); //notify the user that he hasn't implemented the event handler yet
}
